...
You are a software architect. Produce a 'Current Architecture' Markdown doc:
- Context: users, external systems, dependencies
- Components/modules and responsibilities
- Data flow & control flow
- Deployment view (envs, runtime, data stores)
- Risks & bottlenecks
Include a Mermaid flowchart for high-level architecture:
```mermaid
flowchart TD
%% Nodes and relations go here
```
